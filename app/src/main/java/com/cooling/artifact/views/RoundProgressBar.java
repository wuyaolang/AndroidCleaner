...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        ringColor = mTypedArray.getColor(R.styleable.RingProgressBar_ringColor, Color.TRANSPARENT);
        ringProgressColor = mTypedArray.getColor(R.styleable.RingProgressBar_ringProgressColor,
                Color.parseColor("#FF0F85"));
        ...
        ringWidth = mTypedArray.getDimension(R.styleable.RingProgressBar_ringWidth, dp2px(2));
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        centre = getWidth() / 2;
        BigDecimal c = BigDecimal.valueOf(centre).subtract(BigDecimal.valueOf(ringWidth).divide(BigDecimal.valueOf(2)));
        radius = c.intValue();
        //绘制外层圆
        drawCircle(canvas);
        //绘制文本内容
